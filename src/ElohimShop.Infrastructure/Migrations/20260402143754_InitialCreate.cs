        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FechaCreacion = table.Column<DateTime>(type: "timestamp", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id_tipo = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoCliente", x => x.id_tipo);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fecha_vencimiento = table.Column<DateTime>(type: "timestamp", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_rol = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Administrador_Rol_id_rol",
                        column: x => x.id_rol,
                        principalTable: "Rol",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    tipo_cliente_id = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    FechaRegistro = table.Column<DateTime>(type: "timestamp", nullable: false),
                    estado_cuenta = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    id_cliente = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    id_usuario = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    fecha_consulta = table.Column<DateTime>(type: "timestamp", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Consulta", x => x.id_consulta);
                    table.ForeignKey(
                        name: "FK_Consulta_Administrador_id_usuario",
                        column: x => x.id_usuario,
                        principalTable: "Administrador",
                        principalColumn: "id_usuario",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Consulta_Cliente_id_cliente",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fecha_renovacion = table.Column<DateTime>(type: "timestamp", nullable: false),
                    estado_renovacion = table.Column<string>(type: "varchar(60)", maxLength: 60, nullable: true),
                    ...
                    fecha_limite_retiro = table.Column<DateTime>(type: "timestamp", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    fecha_venta = table.Column<DateTime>(type: "timestamp", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Venta_Administrador_usuario_cajero_id",

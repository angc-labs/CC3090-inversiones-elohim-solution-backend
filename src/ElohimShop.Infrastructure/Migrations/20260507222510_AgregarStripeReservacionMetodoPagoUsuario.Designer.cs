...
namespace ElohimShop.Infrastructure.Migrations
{
    ...
    [Migration("20260507222510_AgregarStripeReservacionMetodoPagoUsuario")]
    partial class AgregarStripeReservacionMetodoPagoUsuario
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ElohimShop.Domain.Entities.ArticuloCarrito", b =>
                {
                    ...
                    b.ToTable("ArticuloCarrito", (string)null);
                });

            modelBuilder.Entity("ElohimShop.Domain.Entities.Carrito", b =>
                {
            ...
            modelBuilder.Entity("ElohimShop.Domain.Entities.MetodoPago", b =>
                {
                    ...
                    b.Property<int?>("ExpiraAnio")
                        .HasColumnType("integer")
                        .HasColumnName("expira_anio");

                    b.Property<int?>("ExpiraMes")
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ElohimShop.Domain.Entities.ArticuloCarrito", b =>
                {
                    b.HasOne("ElohimShop.Domain.Entities.Carrito", "Carrito")
                        .WithMany("Articulos")
